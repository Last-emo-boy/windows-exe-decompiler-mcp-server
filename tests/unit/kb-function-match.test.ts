...
import { createKbFunctionMatchHandler, KbFunctionMatchInputSchema } from '../../src/plugins/kb-collaboration/tools/kb-function-match.js'
...
describe('kb.function.match tool', () => {
  ...
  describe('Handler', () => {
    test('should return error for non-existent resource', async () => {
      const handler = createKbFunctionMatchHandler({ workspaceManager: mockWorkspaceManager, database: mockDatabase } as any)
