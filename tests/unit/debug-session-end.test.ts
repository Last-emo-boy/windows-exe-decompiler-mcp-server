/**
 * Unit tests for debug.session.end tool
 */

import { describe, test, expect, beforeEach, jest } from '@jest/globals'
import { createDebugSessionEndHandler, DebugSessionEndInputSchema } from '../../src/plugins/debug-session/tools/debug-session-end.js'
import type { WorkspaceManager } from '../../src/workspace-manager.js'
import type { DatabaseManager } from '../../src/database.js'

describe('debug.session.end tool', () => {
  ...
  describe('Input validation', () => {
    ...
    test('should reject empty input', () => {
      const result = DebugSessionEndInputSchema.safeParse({})
  ...
  describe('Handler', () => {
    test('should return error for non-existent resource', async () => {
      const handler = createDebugSessionEndHandler({ workspaceManager: mockWorkspaceManager, database: mockDatabase } as any)
