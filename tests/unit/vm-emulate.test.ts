/**
 * Unit tests for vm.emulate tool
 */
...
describe('vm.emulate tool', () => {
  ...
  describe('Input validation', () => {
    ...
    test('should reject empty input', () => {
      const result = vmEmulateInputSchema.safeParse({})
  ...
  describe('Handler', () => {
    test('should return error for non-existent resource', async () => {
      const handler = createVmEmulateHandler(mockWorkspaceManager, mockDatabase)
