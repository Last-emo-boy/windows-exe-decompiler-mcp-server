...
export const peExportsExtractToolDefinition: ToolDefinition = {
  name: TOOL_NAME,
  description: 'Extract PE file export table (function names, ordinals, addresses, forwarders)',
 ...
 * Requirements: 3.3
 */
export function createPEExportsExtractHandler(deps: PluginToolDeps) {
